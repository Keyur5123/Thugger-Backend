import {PRODUCT_CREATE_FAIL, PRODUCT_CREATE_REQUEST, PRODUCT_CREATE_REVIEW_FAIL, PRODUCT_CREATE_REVIEW_REQUEST, PRODUCT_CREATE_REVIEW_SUCCESS, PRODUCT_CREATE_SUCCESS, PRODUCT_DELETE_FAIL,
     ...
     PRODUCT_DETAIL_SUCCESS, PRODUCT_LIST_FAIL,PRODUCT_LIST_REQUEST,PRODUCT_LIST_SUCCESS, PRODUCT_UPDATE_FAIL, 
     PRODUCT_UPDATE_REQUEST, PRODUCT_UPDATE_SUCCESS} from "../constants/productConstants"
...
export const listProducts=(keyword="",pageNumber)=>async(dispatch)=>{
    try {
        ...
        const response =await axios.get(`/products?keyword=${keyword}&pageNumber=${pageNumber}`);
